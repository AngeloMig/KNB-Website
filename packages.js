(function(){
  ...
  document.addEventListener('click', function(e){ if(e.target.closest('.md-compare')){ e.preventDefault(); openCompare(); } if(e.target.closest('[data-addons]')){ e.preventDefault(); openAddons(); } });
